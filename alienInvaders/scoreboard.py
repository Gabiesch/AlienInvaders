...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        ...
        self.big_font = pygame.font.SysFont(None, 72)  # Larger font for score
    ...
    def prep_score(self):
        ...
        self.score_image = self.big_font.render(score_str, True,
    ...
    def prep_level(self):
        ...
        self.level_image = self.big_font.render(level_str, True,
                self.text_color, self.settings.bg_color)
    ...
    def prep_ships(self):
        ...
        # Position the ships count at the top left
